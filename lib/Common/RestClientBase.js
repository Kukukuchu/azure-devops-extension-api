...
import { issueRequest } from "./Fetch";
...
var RestClientBase = /** @class */ (function () {
    ...
    */
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this._rootPath.then(function (rootPath) {
                        var requestUrl = rootPath + replaceRouteValues(requestParams.routeTemplate, requestParams.routeValues || {});
    ...
    RestClientBase.prototype._issueRequest = function (requestUrl, apiVersion, requestParams) {
        ...
        var result = issueRequest(requestUrl, fetchOptions, vssRequestOptions);
